...
export const SERVICE_OVERVIEW_ITEMS = [
  ...
  },
  {
    ...
    detailParagraphs: [
      "日本全国の痛車イベントをくまなく掲載中です。イベントの規模に関わらず情報を掲載しています。痛車オンリーのイベントはもちろん、痛車歓迎な痛車オンリーではない一般のカーイベントも一部掲載しております。（痛車枠の用意があることが一定の基準です。）\nまた、みなさまからの情報提供もお待ちしております。イベント掲載はもちろん無料です。\nイベントの掲載は<a href=\"/app/event-submission\">イベント掲載依頼</a>フォームからご依頼ください。",
    ],
  },
  {
    id: "quiet-platform",
    ...
    detailParagraphs: [
      "当サービスは痛車オーナーの痛車ライフを支えるためのインフラとしての機能を提供します。オーナー間のフォロー・フォロワー機能やいいね等の機能はあえて排除しているのが特徴です。",
    ],
  },
  {
    id: "organizer",
