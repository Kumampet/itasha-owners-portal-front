    ...
    <>
      ...
      <main className="flex-1 px-4 pb-16 pt-6 sm:pb-12 sm:pt-8">
        <div className="mx-auto flex w-full max-w-4xl flex-col">
          ...
          <SectionHeadingWithAccent>1. 収集する情報および収集方法</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
            運営者は、本サービスの提供にあたり、次の情報（個人情報を含みます）を取得する場合があります。
          </p>
          ...
          <SectionHeadingWithAccent>2. 個人情報の利用目的</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>3. 個人情報の第三者への提供（開示）</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>4. 業務の委託、国外での処理</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>5. Cookie・広告・解析ツールについて</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>6. 安全管理・保存期間</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>7. ユーザーからの開示・訂正・利用停止等の請求</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>8. 未成年の利用について</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>9. 本ポリシーの変更</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>10. 地域・アクセス環境による利用制限について</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
          ...
          <SectionHeadingWithAccent>11. お問い合わせ窓口</SectionHeadingWithAccent>
          <p className="mb-4 leading-relaxed text-muted-foreground">
