    ...
    <main className="min-h-screen bg-zinc-50 py-8">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="rounded-lg border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <h2 className="mb-4 mt-8 text-2xl font-semibold text-zinc-900">
            1. 収集する情報および収集方法
          </h2>
            ...
            <table className="min-w-full border-collapse border border-zinc-300">
              <thead>
                <tr className="bg-zinc-100">
                  <th className="border border-zinc-300 px-4 py-3 text-left font-semibold text-zinc-900">
                    収集する情報の例
                  </th>
                  <th className="border border-zinc-300 px-4 py-3 text-left font-semibold text-zinc-900">
                    主な収集方法
          ...
          <ul className="mb-6 list-inside list-disc space-y-2">
            <li className="text-zinc-700">
              <span className="font-semibold text-zinc-900">運営者</span>
              ：Kumampet
            </li>
            <li className="text-zinc-700">
              <span className="font-semibold text-zinc-900">X（旧 Twitter）</span>
              ：
              <a
