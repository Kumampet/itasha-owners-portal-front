            ...
            try {
                ...
                if (unreadGroups.length > 0) {
                    ...
                    if (!emailNotificationEnabled ||
                        ...
                        console.log(`[Group Message Reminder] ⏭️ Skipping email to ${user.email}: email_notification_enabled=${emailNotificationEnabled}, group_message_unread_notification_enabled=${groupMessageUnreadNotificationEnabled}`);
                        continue;
                    }
